...
variable "lightdash_image_repo" {
  description = "ECR repo for the ProtoPie-customized Lightdash image (dev runs custom build with internal migrations)"
  default     = "750128304405.dkr.ecr.us-west-2.amazonaws.com/protopie/lightdash"
}

variable "lightdash_oci_tag" {
  description = "container image tag"
  default     = "dev-churn-sort-20260521"
}

#### resources
resource "aws_ecs_cluster" "lightdash_cluster" {
  name = "lightdash-cluster-dev"
  setting {
